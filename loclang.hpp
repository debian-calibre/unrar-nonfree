...
#define   MCHelpCmdV         L"\n  v[a,b,t]      Verbosely list archive contents [all,bare,technical]"
...
#define   MCHelpSwDA         L"\n  da            Delete archive after extraction"
...
#define   MCHelpSwED         L"\n  ed[1]         Exclude directories [empty only]"
...
#define   MCHelpSwVUnr       L"\n  v             Apply list command to all volumes"
...
#define   MErrChangePerm     L"\nWARNING: Cannot change permissions of %s"
